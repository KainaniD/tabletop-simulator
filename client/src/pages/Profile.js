...
export const Profile = () => {
    return (
        <div className="flex pb-10 min-h-[calc(100vh-198px)] gap-5">
            <div className="flex flex-col w-1/3 bg-gray-100 p-5 rounded-lg shadow-md">
                <h1 className="">Your Profile</h1>
                <p className="">Guest User: {clientID}</p>
                <button type="submit"
            ...
            <div className="flex flex-col w-2/3 bg-gray-100 p-5 rounded-lg shadow-md">
                ...
                <div className="mt-5">
                    <div className="overflow-y-auto border px-2 py-2 border-gray-300 rounded-lg">
                        <p>
